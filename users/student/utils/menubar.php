<li><img src="static/images/user.png" alt=""><a href="index.php">Dashboard</a></li>
<li><img src="static/images/user.png" alt=""><a href="Profile.php">Profile</a></li>
<li><img src="static/images/schedule.png" alt=""><a href="myclass.php">Schedule Class</a></li>
